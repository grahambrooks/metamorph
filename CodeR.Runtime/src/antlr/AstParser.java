// $ANTLR 3.4 CodeR.Runtime/src/antlr/Ast.g 2012-09-10 21:52:52
...
public class AstParser extends Parser {
    ...
    // CodeR.Runtime/src/antlr/Ast.g:3:1: ast_tree : ast_node ;
    public final void ast_tree() throws RecognitionException {
        try {
            // CodeR.Runtime/src/antlr/Ast.g:4:2: ( ast_node )
            // CodeR.Runtime/src/antlr/Ast.g:4:4: ast_node
            {
    ...
    // CodeR.Runtime/src/antlr/Ast.g:7:1: ast_node returns [AstNode n] : '(' 'type' ':' type= INT 'line' ':' line= INT 'charPositionInLine' ':' posn= INT 'text' ':' text= STRING 'index' ':' index= INT (child= ast_node )* ')' ;
    public final AstParser.ast_node_return ast_node() throws RecognitionException {
        ...
        try {
            // CodeR.Runtime/src/antlr/Ast.g:8:2: ( '(' 'type' ':' type= INT 'line' ':' line= INT 'charPositionInLine' ':' posn= INT 'text' ':' text= STRING 'index' ':' index= INT (child= ast_node )* ')' )
            // CodeR.Runtime/src/antlr/Ast.g:8:4: '(' 'type' ':' type= INT 'line' ':' line= INT 'charPositionInLine' ':' posn= INT 'text' ':' text= STRING 'index' ':' index= INT (child= ast_node )* ')'
            {
            ...
            // CodeR.Runtime/src/antlr/Ast.g:14:3: (child= ast_node )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // CodeR.Runtime/src/antlr/Ast.g:14:4: child= ast_node
            	    {
